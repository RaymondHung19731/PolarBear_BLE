...
//    public final static String CHEAD_IP = "192.168.15.1";
    ...
    public final static String APPPORT = "22501";
    public final static int CMDPORT = 852;
    public final static int IAPPPORT = Integer.valueOf(APPPORT);
    ...
    public static final int MESSAGE_CONNECTIONLOST = 6;
    public static final int MESSAGE_CONNECTIONFAILED = 7;

    // Key names received from the BluetoothChatService Handler
    public static final String DEVICE_NAME = "device_name";
    public static final String TOAST = "toast";
    public static final String BTMAC = "btmac";
    public static final String T01 = "T-01";
    public static final String T02 = "T-02";
    public static final String MET01 = "T01T02:";
    public static final String MET02 = "T02T01:";
    public static final int BTMSG_TANK_HIT = 1000;
    public static final int BTMSG_CLOCK = 2000;
}
